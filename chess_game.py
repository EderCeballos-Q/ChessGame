...
Original file is located at
    https://colab.research.google.com/drive/15kSFvwa8INoHwUWjvVr4pPoZBweA9fIC
"""

# Instalación de dependencias (solo se necesita la primera vez)
#pip install anytree 
            ...
            if end_col == start_col + 2:
                ...
                if isinstance(rook, Rook) and not rook.has_moved:
                    ...
                    if board[start_row][start_col + 1] is None and board[start_row][start_col + 2] is None:
                        ...
                        print("Castling kingside blocked: squares between king and rook not empty")
                else:
                    print("Castling kingside invalid: Rook has moved or not present")
                return False
            # Queenside castling
                ...
                if isinstance(rook, Rook) and not rook.has_moved:
                    ...
                    if (board[start_row][start_col - 1] is None and
                        ...
                        print("Castling queenside blocked: squares between king and rook not empty")
                else:
                    print("Castling queenside invalid: Rook has moved or not present")
                return False
...
class ChessGame:
    ...
    def generate_game_tree(self):
        ...
        for i, move in enumerate(self.move_history):
            current = Node(move, parent=current, color="white" if i % 2 == 0 else "gray")
        ...
        with open("game_tree.dot") as f:
            src = Source(f.read())
            src.format = "png"
            src.render("game_tree", cleanup=True)
...
# Mostrar imagen del árbol generado
Image("game_tree.png")